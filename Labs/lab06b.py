...
for line in file:
    ...
    print(('{:<s}{:>0.2f}{:>13.2f}{:>12.2f}'\
          .format(name,height,weight,bmi)), file=outfile)
    if height>= maxH:
        maxH=height
    if height<=minH:
        minH=height
...
print(('{:<12s}{:>0.2f}{:>13.2f}{:>12.2f}'\
          .format("Average",avgH,avgW,avgB)), file=outfile)
print(('{:<12s}{:>0.2f}{:>13.2f}{:>12.2f}'\
          .format("Max",maxH,maxW,maxB)), file=outfile)
print(('{:<12s}{:>0.2f}{:>13.2f}{:>12.2f}'\
          .format("Min",minH,minW,minB)),file=outfile)
outfile.close()
